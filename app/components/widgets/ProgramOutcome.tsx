...
const ProgramOutcome = () => {
    return (
        <section className='mt-16 md:mt-28'>
            <Wrapper>
                <div className='flex items-center gap-x-8 flex-col-reverse lg:flex-row'>
                    {/* Left Image */}
                    <div>
                        <Image src={OutComeImg} alt={"Programs Outcome"} />
                    </div>
                    {/* Right Content */}
                        ...
                        <div className='mt-6 grid grid-cols-2 gap-x-2 gap-y-4 '>
                            {outcomePoints.map((item, i) => (
                                <div key={i} className="flex items-center gap-x-2">
                                    <svg className='flex-shrink-0' width="52" height="52" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <radialGradient id="paint0_radial_1_48" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(16.5455 -6.96429) rotate(59.1918) scale(77.3011 169.686)">
                                                <stop offset="0.125" stopColor="#AB1515" />
                                                <stop offset="1" stopColor="#120000" />
                                            </radialGradient>
                                        </defs>
                                    </svg>
                                    <h3 className='font-mdeium text-lg'>{item}</h3>
                                </div>
                            ))}
                        </div>
                    </div>
